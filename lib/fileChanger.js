...
var appendAngularDirectivePatchFunction = function() {
  ...
  function patchDirectiveFactory(name, directiveFactory, currentScript) {
    ...
    return angular.injector.$$annotate(directiveFactory).push(function() {
      // TODO absolutize currentScript.src
      var directivesByName = bsInjular.directivesByUrl[currentScript.src];
      if (!directivesByName) {
        directivesByName = bsInjular.directivesByUrl[currentScript.src] = Object.create(null);
      }
